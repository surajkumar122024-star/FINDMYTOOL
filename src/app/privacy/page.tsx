...
export const metadata: Metadata = {
  ...
  description:
    "Read the FindMyTool privacy policy to understand how we collect, use, and protect your data, including cookies and third-party advertising.",
};
  ...
  return (
    <main className="min-h-screen bg-white text-gray-800 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <p className="mb-4 leading-relaxed">
        This Privacy Policy explains how FindMyTool ("we", "us", "our")
      ...
      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">2. Cookies</h2>
      <p className="mb-4 leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">3. Third-Party Advertising (Google AdSense)</h2>
      <p className="mb-4 leading-relaxed">
      ...
      <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">4. Third-Party Links</h2>
      <p className="mb-4 leading-relaxed">
        Our Site links to third-party tools and websites listed in our
        directory. We are not responsible for the privacy practices or
      ...
      <p className="leading-relaxed">
        ...
        the email listed in our footer.
      </p>
    </main>
  );
}
